...
if sys.argv[1:] == ['server']:
    ...
    while True:
        ...
        print('The client at {} says {}'.format(address, data.decode('utf-8')))
        s.sendto(b'Your data was {} bytes'.format(len(data)), address)
    ...
    print('The server {} says {}'.format(address, data.decode('utf-8')))
