...
# Converted to Python3 by David Branner, 20140706. 
# DOES NOT WORK: `IN.IP_MTU_DISCOVER` is not found in Python 3.
...
try:
    ...
    print('MTU: {}'.format(s.getsockopt(socket.IPPROTO_IP, option)))
else:
